...
from TopZ.utils.decorators.admins import ActualAdminCB
from TopZ.utils.decorators.language import language, languageCB
from TopZ.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from TopZ.utils.inline.start import private_panel
...
async def gib_repo_callback(_, callback_query):
    await callback_query.edit_message_media(
        media=InputMediaVideo("https://graph.org/file/5223fe82627c2cf0639f0.mp4", has_spoiler=True),
