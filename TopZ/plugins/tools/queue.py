...
from TopZ.utils import TopBin, get_channeplayCB, seconds_to_min
from TopZ.utils.database import get_cmode, is_active_chat, is_music_playing
from TopZ.utils.decorators.language import language, languageCB
from TopZ.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://graph.org/file/e9eb24350ac3fa98bc49d.mp4",
        caption=_["queue_1"],
    )
